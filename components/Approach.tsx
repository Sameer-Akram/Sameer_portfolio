    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="We'll collaborate to define the goals and features of your mobile app. We'll discuss user personas, app architecture, and the overall user experience to ensure your app meets your business objectives."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Once the planning is complete, I start coding the app. From initial wireframes to the final user interface, I keep you informed about the development progress, incorporating your feedback to refine the app."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="This is where the magic happens! After through testing to ensure the app is bug-free and runs smoothly, I prepare it for launch. I'll assist with app store submission and ensure your app reaches your audience seamlessly."
        >
          <CanvasRevealEffect
            animationSpeed={3}
